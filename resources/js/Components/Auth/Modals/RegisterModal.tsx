...
const RegisterModal: React.FC<Props> = ({ onClose, isOpen, handleChange, submitForm }) => {
    ...
    <Modal show={isOpen} onHide={onClose} centered backdrop="static">
      ...
      <Modal.Body>
        <form className="p-3"
          ...
          <div className="">
            <label htmlFor="email"
              className="block mb-2 text-sm font-medium text-gray-700">Email
            </label>
            <input type="email"
              id="email"
          ...
          <div className="relative mb-3">
            <label htmlFor="password"
              className="block mb-2 text-sm font-medium text-gray-700">Password
            </label>
            <input
          ...
          <Button variant="primary"
            type="submit"
            className="w-100 bg-green-600 border-0 hover:bg-green-700">
            Register
          </Button>
        </form>
      </Modal.Body>
